...
import defu, {
  defuFn,
} from "file:///app/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs";
...
import {
  ...
  toNodeListener,
  lazyEventHandler,
} from "file:///app/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs";
...
} from "file:///app/node_modules/.pnpm/node-mock-http@1.0.4/node_modules/node-mock-http/dist/index.mjs";
import {
  createFetch,
  Headers as Headers$1,
} from "file:///app/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs";
import { digest } from "file:///app/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs";
import {
  dirname,
  resolve,
} from "file:///app/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs";
import {
  toRouteMatcher,
  createRouter,
} from "file:///app/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs";
...
} from "file:///app/node_modules/.pnpm/ufo@1.6.3/node_modules/ufo/dist/index.mjs";
import { getContext } from "file:///app/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs";
import {
  createStorage,
  prefixStorage,
} from "file:///app/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_ioredis@5.10.1/node_modules/unstorage/dist/index.mjs";
import unstorage_47drivers_47fs_45lite from "file:///app/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_ioredis@5.10.1/node_modules/unstorage/drivers/fs-lite.mjs";
...
const serverAssets = [{ baseName: "server", dir: "/app/src/assets" }];
...
storage.mount("src", unstorage_47drivers_47fs({ driver: "fs", readOnly: true, base: "/app/src" }));
storage.mount(
  "build",
  unstorage_47drivers_47fs({ driver: "fs", readOnly: false, base: "/app/.nitro" }),
);
storage.mount(
  "cache",
  unstorage_47drivers_47fs({ driver: "fs", readOnly: false, base: "/app/.nitro/cache" }),
);
...
const _fKtwzv = eventHandler((event) => {
...
const handlers = [
  { route: "", handler: _fKtwzv, lazy: false, middleware: true, method: undefined },
];
