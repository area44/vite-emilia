...
- **Site Metadata**: Edit `src/utils/site.config.ts` to update the site title, description, and social handles.
- **Emilia Config**: Edit `src/utils/site.config.ts` to change your name, location, and social media links.
