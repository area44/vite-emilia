    ...
    function Ha(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === y
          ...
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` && i && i.$$typeof === te && Na(i) === t.type))
                ...
                for (var l = o.key; r !== null; ) {
                  if (r.key === l) {
                    if (((l = o.type), l === y)) {
                      ...
                      r.elementType === l ||
                      (typeof l == `object` && l && l.$$typeof === te && Na(l) === r.type)
                    ) {
            ...
            if (
              ...
              if (
                ...
                (e === `pointerout` || e === `pointerover`) &&
                  ((d = j), (g = `onPointerLeave`), (p = `onPointerEnter`), (m = `pointer`)),
                (f = l == null ? c : Et(l)),
                (h = u == null ? c : Et(u)),
          ...
          (x &&
            (nr &&
              ...
              (sr || x !== `onCompositionStart`
                ...
                : ((bn = i), (xn = `value` in bn ? bn.value : bn.textContent), (sr = !0))),
            (y = Ed(r, x)),
            0 < y.length &&
...
function le(e, t = [], n = [], r = ``, i = !1) {
  let a = (e, a, o = i, s) => {
    ...
    (e.children &&
      ...
      !(e.path == null && !e.index) && t.push({ path: l, score: ve(l, e.index), routesMeta: u }));
  };
  return (
    e.forEach((e, t) => {
...
var Te = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i;
function Ee(e, t = `/`) {
  let { pathname: n, search: r = ``, hash: i = `` } = typeof e == `string` ? ae(e) : e,
    a;
  return (
    n
      ? ((n = n.replace(/\/\/+/g, `/`)),
...
function je(e, t, n, r = !1) {
  ...
  typeof e == `string`
    ? (i = ae(e))
    : ((i = { ...e }),
      T(!i.pathname || !i.pathname.includes(`?`), Oe(`?`, `pathname`, `search`, i)),
      T(!i.pathname || !i.pathname.includes(`#`), Oe(`#`, `pathname`, `hash`, i)),
...
var He = [`GET`, ...Ve];
new Set(He);
var Ue = S.createContext(null);
Ue.displayName = `DataRouter`;
var We = S.createContext(null);
We.displayName = `DataRouterState`;
var Ge = S.createContext(!1),
  Ke = S.createContext({ isTransitioning: !1 });
Ke.displayName = `ViewTransition`;
var qe = S.createContext(new Map());
...
function it(e, { relative: t } = {}) {
  T(at(), `useHref() may be used only in the context of a <Router> component.`);
  let { basename: n, navigator: r } = S.useContext(Ye),
...
function at() {
  return S.useContext(Xe) != null;
}
function ot() {
  return (
    T(at(), `useLocation() may be used only in the context of a <Router> component.`),
    S.useContext(Xe).location
  );
}
var st = `You should call navigate() in a React.useEffect(), not when your component is first rendered.`;
function ct(e) {
  S.useContext(Ye).static || S.useLayoutEffect(e);
}
function lt() {
...
function ut() {
  T(at(), `useNavigate() may be used only in the context of a <Router> component.`);
  let e = S.useContext(Ue),
    { basename: t, navigator: n } = S.useContext(Ye),
    { matches: r } = S.useContext(Ze),
    { pathname: i } = ot(),
  ...
  return (
    ...
    S.useCallback(
      (r, s = {}) => {
        if ((E(o.current, st), !o.current)) return;
        if (typeof r == `number`) {
          n.go(r);
          return;
        }
...
function mt(e, t, n) {
  T(at(), `useRoutes() may be used only in the context of a <Router> component.`);
  let { navigator: r } = S.useContext(Ye),
...
Please change the parent <Route path="${e}"> to <Route path="${e === `/` ? `*` : `${e}/*`}">.`,
  ...
  (E(l || m != null, `No routes matched location "${d.pathname}${d.search}${d.hash}" `),
    E(
      m == null ||
      ...
      m.map((e) =>
        Object.assign({}, e, {
          ...
          pathname: Me([
            c,
            r.encodeLocation
              ? r.encodeLocation(e.pathname.replace(/\?/g, `%3F`).replace(/#/g, `%23`)).pathname
              : e.pathname,
          ]),
          pathnameBase:
            e.pathnameBase === `/`
              ...
              : Me([
                  c,
                  r.encodeLocation
                    ? r.encodeLocation(e.pathnameBase.replace(/\?/g, `%3F`).replace(/#/g, `%23`))
                        .pathname
                    : e.pathnameBase,
                ]),
        }),
...
var gt = S.createElement(ht, null),
  _t = class extends S.Component {
    constructor(e) {
      (super(e),
      ...
      let t =
        e === void 0
          ...
          : S.createElement(
              ...
              S.createElement(Qe.Provider, { value: e, children: this.props.component }),
            );
      return this.context ? S.createElement(yt, { error: e }, t) : t;
    }
  };
_t.contextType = Ge;
var vt = new WeakMap();
function yt({ children: e, error: t }) {
  let { basename: n } = S.useContext(Ye);
...
function bt({ routeContext: e, match: t, children: n }) {
  ...
  return (
    ...
    S.createElement(Ze.Provider, { value: e }, n)
  );
}
function xt(e, t = [], n) {
  let r = n?.state;
...
function Ot() {
  ...
  return S.useMemo(() => e.map((e) => O(e, t)), [e, t]);
}
function kt() {
  let e = S.useContext(Qe),
    t = wt(`useRouteError`),
    n = Et(`useRouteError`);
...
(S.useOptimistic, S.memo(Nt));
function Nt({ routes: e, future: t, state: n, isStatic: r, onError: i }) {
  ...
  return (
    ...
    h == null
      ...
      : S.createElement(
          Ye.Provider,
          { value: c },
          S.createElement(Xe.Provider, { children: t, value: h }),
        )
  );
}
...
function Xt(e, t) {
  ...
  if (Ht(e)) {
    ...
    if (
      ...
      (i = Yt(e.getAttribute(`formenctype`)) || Yt(o.getAttribute(`enctype`)) || zt),
      (a = new FormData(o, e)),
      !qt())
    ) {
...
function fn() {
  let e = S.useContext(Ue);
  return (en(e, `You must render this element inside a <DataRouterContext.Provider> element`), e);
}
function pn() {
  let e = S.useContext(We);
  return (
    en(e, `You must render this element inside a <DataRouterStateContext.Provider> element`), e
  );
}
...
function hn() {
  ...
  return (en(e, `You must render this element inside a <HydratedRouter> element`), e);
}
function gn(e, t) {
...
function vn({ page: e, ...t }) {
  let { router: n } = fn(),
    r = S.useMemo(() => ce(n.routes, e, n.basename), [n.routes, e, n.basename]);
...
function bn({ page: e, matches: t, ...n }) {
  ...
  return S.createElement(
    S.Fragment,
    null,
    f.map((e) => S.createElement(`link`, { key: e, rel: `prefetch`, as: `fetch`, href: e, ...n })),
    p.map((e) => S.createElement(`link`, { key: e, rel: `modulepreload`, href: e, ...n })),
    m.map(({ key: e, link: t }) =>
...
var Tn = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  En = S.forwardRef(function (
    ...
    let { basename: h, navigator: g, unstable_useTransitions: _ } = S.useContext(Ye),
      v = typeof l == `string` && Tn.test(l),
      y = Be(l, h);
    l = y.to;
    let b = it(l, { relative: r }),
      x = ot(),
      C = null;
    if (o) {
      let e = je(o, [], x.unstable_mask ? x.unstable_mask.pathname : `/`, !0);
    ...
    let ne = !(y.isExternal || i),
      re = S.createElement(`a`, {
        ...p,
        ...T,
        href: (ne ? C : void 0) || y.absoluteURL || b,
        onClick: ne ? te : e,
        ref: xn(m, ee),
        target: c,
        "data-discover": !v && t === `render` ? `true` : void 0,
      });
    return w && !v ? S.createElement(S.Fragment, null, re, S.createElement(vn, { page: b })) : re;
  });
En.displayName = `Link`;
var Dn = S.forwardRef(function (
  ...
  let u = ft(a, { relative: c.relative }),
    d = ot(),
    f = S.useContext(We),
    { navigator: p, basename: m } = S.useContext(Ye),
    h = f != null && Un(u) && o === !0,
  ...
  ee =
    typeof n == `function`
      ? n(C)
      : [n, b ? `active` : null, x ? `pending` : null, h ? `transitioning` : null]
          .filter(Boolean)
          .join(` `);
  let T = typeof i == `function` ? i(C) : i;
  return S.createElement(
    En,
    { ...c, "aria-current": w, className: ee, ref: l, style: T, to: a, viewTransition: o },
...
var On = S.forwardRef(
  (
    ...
    let { unstable_useTransitions: h } = S.useContext(Ye),
      g = In(),
      _ = Ln(s, { relative: l }),
...
function In() {
  ...
  return S.useCallback(
    async (e, a = {}) => {
      ...
      a.navigate === !1
        ? await r(a.fetcherKey || Fn(), n, a.action || o, {
...
function Bn(e, t, n, r) {
  let i = null;
  return (
    r && (i = r(n === `/` ? e : { ...e, pathname: we(e.pathname, n) || e.pathname }, t)),
    (i ??= e.key),
    i
  );
}
...
var Wn = l(_()),
  ...
  Jn = ({ id: e, ...t }) =>
    (0, j.jsx)(`svg`, { ...t, children: (0, j.jsx)(`use`, { href: `/icons.svg#${e}` }) }),
  Yn = () =>
    (0, j.jsxs)(j.Fragment, {
      children: [
        (0, j.jsx)(`div`, {
          className: `absolute inset-0 h-full w-full text-background-pattern`,
          children: (0, j.jsx)(Jn, { id: `bgPattern`, height: `100%`, width: `100%` }),
        }),
        (0, j.jsx)(`div`, {
          className: `absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/15 dark:to-black/35`,
        }),
      ],
    }),
  Xn = () => {
    let { socialMedia: e } = Kn();
    return (0, j.jsx)(j.Fragment, {
      children: e.map((e) =>
        (0, j.jsx)(
          `a`,
          { href: e.href, className: `text-primary hover:text-secondary`, children: e.title },
          e.title,
        ),
      ),
    });
  ...
  Zn = () => {
    let { name: e, location: t, assetsPath: n } = Kn();
          ...
          children: [
            (0, j.jsx)(`div`, {
              ...
              children: (0, j.jsx)(`div`, {
                className: `inline-flex h-[100px] w-[100px] items-center justify-center overflow-hidden rounded-full bg-white shadow-lg md:h-[140px] md:w-[140px]`,
            ...
            (0, j.jsx)(`div`, {
              ...
              children: (0, j.jsx)(`h1`, {
                className: `mt-4 text-4xl font-bold text-heading md:text-5xl`,
                children: e,
              }),
            }),
            (0, j.jsx)(`div`, {
              className: `animate-in slide-in-from-bottom-8 delay-250 duration-700`,
              children: (0, j.jsxs)(`div`, {
                className: `mt-2 flex items-center justify-center gap-2 text-text`,
                children: [
                  (0, j.jsx)(Jn, {
                    id: `location`,
                    width: `20px`,
    ...
    return (
      ...
      (0, j.jsx)(`div`, {
        ...
        children: (0, j.jsx)(`button`, {
          ...
          "aria-label": e ? `Activate Light Mode` : `Activate Dark Mode`,
          children: e
            ? (0, j.jsxs)(`svg`, {
                ...
                className: `text-toggle-icon`,
                children: [
                  (0, j.jsx)(`circle`, { cx: `12`, cy: `12`, r: `4` }),
                  (0, j.jsx)(`path`, { d: `M12 2v2` }),
                  (0, j.jsx)(`path`, { d: `M12 20v2` }),
                  (0, j.jsx)(`path`, { d: `m4.93 4.93 1.41 1.41` }),
                  (0, j.jsx)(`path`, { d: `m17.66 17.66 1.41 1.41` }),
                  (0, j.jsx)(`path`, { d: `M2 12h2` }),
                  (0, j.jsx)(`path`, { d: `M20 12h2` }),
                  (0, j.jsx)(`path`, { d: `m6.34 17.66-1.41 1.41` }),
                  (0, j.jsx)(`path`, { d: `m19.07 4.93-1.41 1.41` }),
                ],
              })
            : (0, j.jsx)(`svg`, {
                xmlns: `http://www.w3.org/2000/svg`,
                ...
                strokeLinejoin: `round`,
                className: `text-toggle-icon`,
                children: (0, j.jsx)(`path`, { d: `M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z` }),
              }),
        }),
      })
    );
  ...
  $n = () =>
    (0, j.jsx)(`footer`, {
      className: `mt-auto bg-gradient-to-b from-transparent to-black/5 pt-24 pb-16 dark:to-black/30`,
      children: (0, j.jsx)(`div`, {
        className: `container`,
        children: (0, j.jsxs)(`div`, {
  ...
  er = ({ children: e }) =>
    (0, j.jsxs)(`div`, {
      ...
      children: [
        (0, j.jsx)(`main`, { className: `relative flex-grow`, children: e }),
        (0, j.jsx)($n, {}),
      ],
    }),
  tr = `0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz#$%*+,-.:;=?@[]^_{|}~`.split(
    ``,
  ),
  nr = (e) => {
    let t = 0;
  ...
  ir = (e) => {
    ...
    return Math.trunc(
      t <= 0.0031308
        ? t * 12.92 * 255 + 0.5
        : (1.055 * t ** 0.4166666666666667 - 0.055) * 255 + 0.5,
    );
  },
  ar = (e) => (e < 0 ? -1 : 1),
  or = (e, t) => ar(e) * Math.abs(e) ** +t,
  ...
  cr = (e) => {
    if (!e || e.length < 6) throw new sr(`The blurhash string must be at least 6 characters`);
    let t = nr(e[0]),
      n = Math.floor(t / 9) + 1,
      r = (t % 9) + 1;
    if (e.length !== 4 + 2 * r * n)
      throw new sr(
        `blurhash length mismatch: length is ${e.length} but it should be ${4 + 2 * r * n}`,
      );
  },
  lr = (e) => {
    let t = e >> 16,
  ...
  ur = (e, t) => {
    let n = Math.floor(e / 361),
      r = Math.floor(e / 19) % 19,
      i = e % 19;
    return [or((n - 9) / 9, 2) * t, or((r - 9) / 9, 2) * t, or((i - 9) / 9, 2) * t];
  },
  dr = (e, t, n, r) => {
    (cr(e), (r |= 1));
    let i = nr(e[0]),
    ...
    for (let t = 0; t < c.length; t++)
      t === 0
        ? (c[t] = lr(nr(e.substring(2, 6))))
        : (c[t] = ur(nr(e.substring(4 + t * 2, 6 + t * 2)), s * r));
    let l = t * 4,
      u = new Uint8ClampedArray(l * n);
    for (let e = 0; e < n; e++)
      for (let r = 0; r < t; r++) {
        let i = 0,
          s = 0,
        ...
        for (let l = 0; l < a; l++)
          for (let a = 0; a < o; a++) {
            let u = Math.cos((Math.PI * r * a) / t) * Math.cos((Math.PI * e * l) / n),
              f = c[a + l * o];
  ...
  vr = (e, t, n) =>
    t in e ? fr(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n),
  yr = (e, t) => {
  ...
  Sr = class extends S.PureComponent {
    constructor() {
      (super(...arguments),
        (this.canvas = null),
        (this.handleRef = (e) => {
    ...
    render() {
      let e = this.props,
        { hash: t, height: n, width: r } = e,
        i = xr(e, [`hash`, `height`, `width`]);
      return S.createElement(`canvas`, br(yr({}, i), { height: n, width: r, ref: this.handleRef }));
    }
  };
Sr.defaultProps = { height: 128, width: 128 };
var Cr = {
    position: `absolute`,
    top: 0,
    bottom: 0,
  ...
  wr = class extends S.PureComponent {
    componentDidUpdate() {
    ...
    render() {
      let e = this.props,
        { hash: t, height: n, width: r, punch: i, resolutionX: a, resolutionY: o, style: s } = e,
        c = xr(e, [`hash`, `height`, `width`, `punch`, `resolutionX`, `resolutionY`, `style`]);
      return S.createElement(
        `div`,
        br(yr({}, c), {
          style: br(yr({ display: `inline-block`, height: n, width: r }, s), {
            position: `relative`,
          }),
        }),
        S.createElement(Sr, { hash: t, height: o, width: a, punch: i, style: Cr }),
      );
    }
  };
wr.defaultProps = { height: 128, width: 128, resolutionX: 32, resolutionY: 32 };
var Tr = ({
    src: e,
    alt: t,
    hash: n,
    ...
    let [c, l] = (0, S.useState)(!1),
      u = a || (r && i ? `${r} / ${i}` : void 0);
    return (0, j.jsxs)(`div`, {
      className: `relative overflow-hidden ${o}`,
      style: { aspectRatio: u },
      children: [
        n &&
          !c &&
        ...
        (0, j.jsx)(`img`, {
          ...
          loading: s,
          onLoad: () => l(!0),
          className: `block h-full w-full object-cover transition-opacity duration-500 ${c ? `opacity-100` : `opacity-0`}`,
        }),
      ],
    });
  },
  Er = ({ item: e, overlay: t = `#000`, eager: n, aspectRatio: r }) =>
    (0, j.jsxs)(En, {
      "aria-label": `Visit ${e.title} project page`,
      ...
      children: [
        (0, j.jsx)(`div`, {
          ...
          style: { backgroundColor: `${t}E6` },
          "data-name": `card-overlay`,
          children: (0, j.jsx)(`h2`, {
            className: `m-0 text-center text-2xl font-bold text-white drop-shadow-lg`,
            children: e.title,
          }),
        }),
        (0, j.jsx)(Tr, {
  ...
  Dr = () => ({
    ...
    siteUrl: `https://vite-emilia.onrender.com`,
  ...
  Or = ({
    ...
    return (
      S.useEffect(() => {
        ((document.title = d.title), (document.documentElement.lang = u));
      }, [d.title, u]),
      (0, j.jsx)(j.Fragment, { children: i })
    );
  },
  kr = ({ projects: e }) =>
    e.length === 0
          ...
          children: [
            ...
            (0, j.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, j.jsx)(`p`, {
                  className: `text-text-muted`,
                  children: `It looks like you haven't added any projects yet. Check the README for instructions on how to get started!`,
                }),
              ],
            }),
          ],
      ...
      : (0, j.jsxs)(er, {
          children: [
            ...
            (0, j.jsx)(`main`, {
              className: `relative`,
              children: (0, j.jsx)(`div`, {
                className: `animate-in slide-in-from-bottom-8 delay-600 duration-700`,
                children: (0, j.jsx)(`div`, {
                  className: `container -mt-32 grid grid-cols-1 items-start gap-8 md:grid-cols-[repeat(auto-fill,minmax(350px,1fr))]`,
                  children: e.map((e, t) => {
                    let n = e.background || `#000`;
                    return (0, j.jsx)(
                      Er,
                      { eager: t === 0, item: e, overlay: n, aspectRatio: `4 / 5` },
                      e.slug,
                    );
                  }),
                }),
  ...
  Ar = `/assets/angelo-pantazis-h0AnGGgseio-unsplash-BWI3X4iA.jpeg`,
  jr = `/assets/heather-ford-vAfCO8xrz0I-unsplash-CwJSFlQY.jpeg`,
  Mr = `/assets/di_an_h-9jsV5uKbAEM-unsplash-CwVdKMK7.jpeg`,
  Nr = `/assets/jordan-whitfield-3cNc1U7nJcs-unsplash-DwHhbYq_.jpeg`,
  Pr = `/assets/Astronaut-KFt_Olcx.jpeg`,
  Fr = `/assets/Reflections-CQ8j5rMw.jpeg`,
  Ir = `/assets/Space-Tourism-CzzBGq9y.jpeg`,
  Lr = `/assets/sean-foley-0JD7kvxAq0Y-unsplash-B9X-rT5T.jpeg`,
  Rr = `/assets/sean-foley-z4gWzj0p93c-unsplash-DPPZnxsb.jpeg`,
  zr = s({ default: () => Hr, frontmatter: () => Br }),
  Br = {
...
function Hr(e = {}) {
  ...
  return t ? (0, j.jsx)(t, { ...e, children: (0, j.jsx)(Vr, { ...e }) }) : Vr(e);
}
var Ur = s({ default: () => Kr, frontmatter: () => Wr }),
  Wr = {
...
function Kr(e = {}) {
  let { wrapper: t } = e.components || {};
  return t ? (0, j.jsx)(t, { ...e, children: (0, j.jsx)(Gr, { ...e }) }) : Gr(e);
}
var qr = s({ default: () => Xr, frontmatter: () => Jr }),
  Jr = { cover: `./Space-Tourism.jpg`, date: `2019-09-12`, title: `Minimal Blog`, areas: [`Blog`] };
function Yr(e) {
  return (0, j.jsx)(j.Fragment, {});
}
function Xr(e = {}) {
  let { wrapper: t } = e.components || {};
  return t ? (0, j.jsx)(t, { ...e, children: (0, j.jsx)(Yr, { ...e }) }) : Yr(e);
}
var Zr = s({ default: () => ei, frontmatter: () => Qr }),
  Qr = {
...
function ei(e = {}) {
  let { wrapper: t } = e.components || {};
  return t ? (0, j.jsx)(t, { ...e, children: (0, j.jsx)($r, { ...e }) }) : $r(e);
}
var ti = {
    "src/content/projects/ars-aurea/angelo-pantazis-h0AnGGgseio-unsplash.jpg": {
      hash: `UUE|6pM{k?x]G^xuNaSh0gW=rqRj$$Rjr?s-`,
      width: 1703,
      height: 2560,
    },
    "src/content/projects/ars-aurea/heather-ford-vAfCO8xrz0I-unsplash.jpg": {
      hash: `UMC9q,o~pdpd%2kXW=jEpybcVXadx]VrV@Xo`,
      width: 1707,
      height: 2560,
    },
    "src/content/projects/jodie/di_an_h-9jsV5uKbAEM-unsplash.jpg": {
      hash: `UG8;c;nf1UXBx{j]NFaw1nbI]yjXEna}%0oJ`,
      width: 2560,
      height: 1688,
    },
    "src/content/projects/jodie/jordan-whitfield-3cNc1U7nJcs-unsplash.jpg": {
      hash: `UTPAr{{#+I={;3XRoyixnPjZKNj?[[njJ*S}`,
      width: 2048,
      height: 2560,
    },
    "src/content/projects/minimal-blog/Astronaut.jpg": {
      hash: `U9HTZ|0n01NN?80A$w=^}k0%tQso}:oNT0IW`,
      width: 2500,
      height: 2500,
    },
    "src/content/projects/minimal-blog/Reflections.jpg": {
      hash: `UDGlYT%f00s+00D%M_x[~pxZ?Hx]00obXAIo`,
      width: 1707,
      height: 2560,
    },
    "src/content/projects/minimal-blog/Space-Tourism.jpg": {
      hash: `UFC$=r~q0000?b-pNFE100D%-=%gnhRjS5S5`,
      width: 2560,
      height: 2560,
    },
    "src/content/projects/neon-lights/sean-foley-0JD7kvxAq0Y-unsplash.jpg": {
      hash: `U4A1n=%N9qL0*JXTxvTH00Exj;a#1GyEImRQ`,
      width: 2048,
      height: 2560,
    },
    "src/content/projects/neon-lights/sean-foley-z4gWzj0p93c-unsplash.jpg": {
      hash: `U66[amKi1X^UUuKMK%%4B4%O-EB4LKxIv$J~`,
      width: 2048,
      height: 2560,
    },
  },
  ni = Object.assign({
    "../content/projects/ars-aurea/angelo-pantazis-h0AnGGgseio-unsplash.jpg": Ar,
    "../content/projects/ars-aurea/heather-ford-vAfCO8xrz0I-unsplash.jpg": jr,
    "../content/projects/jodie/di_an_h-9jsV5uKbAEM-unsplash.jpg": Mr,
    "../content/projects/jodie/jordan-whitfield-3cNc1U7nJcs-unsplash.jpg": Nr,
    "../content/projects/minimal-blog/Astronaut.jpg": Pr,
    "../content/projects/minimal-blog/Reflections.jpg": Fr,
    "../content/projects/minimal-blog/Space-Tourism.jpg": Ir,
    "../content/projects/neon-lights/sean-foley-0JD7kvxAq0Y-unsplash.jpg": Lr,
    "../content/projects/neon-lights/sean-foley-z4gWzj0p93c-unsplash.jpg": Rr,
  }),
  ri = (e) => e.replace(/^\.\.\/content\//, `src/content/`),
  ii = async () =>
    Object.entries(
      Object.assign({
        "../content/projects/ars-aurea/index.mdx": zr,
        "../content/projects/jodie/index.mdx": Ur,
        "../content/projects/minimal-blog/index.mdx": qr,
        "../content/projects/neon-lights/index.mdx": Zr,
      }),
    )
      .map(([e, t]) => {
        let n = e.substring(0, e.lastIndexOf(`/`) + 1),
          r = e.split(`/`).slice(-2, -1)[0] ?? `unknown`,
          { frontmatter: i } = t,
          a = `${n}${i.cover.replace(/^\.\//, ``)}`,
          o = ni[a] ?? i.cover,
          s = ti[ri(a)],
        ...
        return (i.background !== void 0 && (c.background = i.background), c);
      })
  ...
  ai = async (e) => {
    ...
    for (let [r, i] of Object.entries(t)) {
      let t = r.split(`/`).slice(-2, -1)[0] ?? `unknown`;
      if ((i.frontmatter.slug ?? `/${t}`) === e) {
        n = r.substring(0, r.lastIndexOf(`/`) + 1);
        break;
      }
    }
    return n
  ...
  oi = () => {
    ...
    return (
      ...
      (0, j.jsx)(kr, { projects: e })
    );
  },
  si = ({ title: e, areas: t, description: n = ``, date: r }) => {
    let { name: i } = Kn();
    return (0, j.jsxs)(`header`, {
      ...
      children: [
        (0, j.jsx)(Yn, {}),
        (0, j.jsxs)(`div`, {
          className: `z-10 container my-8 text-center`,
          children: [
            (0, j.jsx)(`div`, {
              className: `animate-in fade-in duration-700`,
              children: (0, j.jsx)(`div`, {
                ...
                children: (0, j.jsx)(En, {
                  ...
                  children: (0, j.jsx)(`img`, {
                    src: `/assets/avatar-Bs_r76O8.svg`,
                    alt: `Avatar`,
            ...
            (0, j.jsxs)(`div`, {
              className: `mt-8 mb-24 md:mb-32`,
              children: [
                (0, j.jsx)(`div`, {
                  className: `animate-in slide-in-from-top-8 duration-700`,
                  children: (0, j.jsx)(`h1`, {
                    className: `mt-4 text-4xl font-bold text-heading md:text-5xl`,
                    children: e,
                  }),
                ...
                (0, j.jsxs)(`div`, {
                  className: `animate-in fade-in delay-500 duration-700`,
                  children: [
                    (0, j.jsx)(`p`, { className: `mt-8 mb-0 text-lg`, children: r }),
                    (0, j.jsx)(`div`, {
                      className: `text-text-muted`,
                      children: t.map((e, t) =>
                        (0, j.jsxs)(`span`, { children: [t > 0 && `, `, e] }, e),
                      ),
                    }),
                    n &&
                      (0, j.jsx)(`div`, {
                        className: `max-width-[900px] mx-auto mt-12 text-left break-words`,
                        children: n,
                      }),
                  ],
                }),
  ...
  ci = ({ prev: e, next: t }) =>
    (0, j.jsxs)(`div`, {
      ...
      children: [
        (0, j.jsxs)(`div`, {
          className: `mb-8 grid grid-cols-[auto_1fr] items-center gap-4 md:grid-cols-[250px_1fr]`,
          children: [
            (0, j.jsx)(`h2`, {
              className: `m-0 text-sm font-medium tracking-widest whitespace-nowrap text-text-muted uppercase`,
              children: `More Projects`,
            }),
            (0, j.jsx)(`div`, { className: `h-0.5 w-full bg-muted` }),
          ],
        }),
        (0, j.jsxs)(`div`, {
          className: `grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-12`,
          children: [
            e && (0, j.jsx)(Er, { item: e, aspectRatio: `16 / 9` }),
            t && (0, j.jsx)(Er, { item: t, aspectRatio: `16 / 9` }),
          ],
        }),
      ],
    }),
  li = ({ project: e, images: t, prev: n, next: r, children: i }) =>
    (0, j.jsxs)(er, {
      children: [
        (0, j.jsx)(Or, {
          title: e.title,
        ...
        (0, j.jsx)(si, { title: e.title, description: i, areas: e.areas, date: e.date }),
        (0, j.jsxs)(`div`, {
          className: `relative z-10 container -mt-24 md:-mt-32`,
          children: [
            (0, j.jsx)(`div`, {
              className: `animate-in fade-in delay-800 duration-700`,
              children: t.map((e) =>
                (0, j.jsx)(
                  Tr,
                  {
    ...
    if (
      ((0, S.useEffect)(() => {
        (async () => {
          if (!e) return;
          let t = await ii(),
            r = t.findIndex((t) => t.slug === `/${e}` || t.slug === e);
          if (r !== -1) {
            let e = t[r];
            if (e) {
              (n(e),
                o(r > 0 ? (t[r - 1] ?? null) : null),
                c(r < t.length - 1 ? (t[r + 1] ?? null) : null));
              let a = e.slug;
              i(await ai(a));
            }
          }
      ...
      return null;
    let l = t.content;
    return (0, j.jsx)(li, { project: t, images: r, prev: a, next: s, children: (0, j.jsx)(l, {}) });
  },
  di = () =>
    (0, j.jsxs)(er, {
      children: [
        ...
        (0, j.jsx)(`div`, {
          className: `container`,
          children: (0, j.jsxs)(`p`, {
            children: [`Oh, no!`, (0, j.jsx)(`br`, {}), `You found a page that doesn't exist.`],
          }),
        }),
      ],
    });
Wn.createRoot(document.getElementById(`root`)).render(
  (0, j.jsx)(S.StrictMode, {
    children: (0, j.jsx)(Cn, {
      children: (0, j.jsx)(() => {
        let { pathname: e } = ot();
        return (
          ...
          (0, j.jsxs)(It, {
            children: [
              (0, j.jsx)(Pt, { path: `/`, element: (0, j.jsx)(oi, {}) }),
              (0, j.jsx)(Pt, { path: `/:slug`, element: (0, j.jsx)(ui, {}) }),
              (0, j.jsx)(Pt, { path: `*`, element: (0, j.jsx)(di, {}) }),
            ],
          })
        );
      }, {}),
